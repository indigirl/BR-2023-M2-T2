...
from dino_runner.utils.constants import RUNNING, JUMPING, DUCKING, DEFAULT_TYPE, SHIELD_TYPE, DUCKING_SHIELD, JUMPING_SHIELD, RUNNING_SHIELD, HAMMER_TYPE, DUCKING_HAMMER, JUMPING_HAMMER, RUNNING_HAMMER, MUSHROOM_TYPE, RUNNING_BIG, DUCKING_BIG, JUMPING_BIG, HEART, HEART_TYPE
...
#BIG_IMG = {MUSHROOM_TYPE: RUNNING_BIG}

X_POS = 80
Y_POS = 310
Y_POS_DUCK = 340
#Y_POS_BIG = 250 #bom para o duck
JUMP_VEL = 8.5
...
class Dinosaur(Sprite):
    ...
    def run(self):
        self.image = RUN_IMG[self.type][self.step_index // 5]# if self.type != "mushroom" else BIG_IMG[self.type][self.step_index // 5]
        self.dino_rect = self.image.get_rect()
        self.dino_rect.x = X_POS
